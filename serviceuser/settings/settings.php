...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 mx-auto">
        <form enctype="multipart/form-data" action="submit-settings.php" method="post" name="settings" id="picture-settings">
          ...
          <button class="btn btn-primary" type="submit" name="btn" id="picture-settings">Submit form</button>
        </form>
      </div>
    </div>
  </div>
